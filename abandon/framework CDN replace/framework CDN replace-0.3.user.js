...
(function() {
    ...
    for (i = 0; i < frameworks.length; i += 1) {
        ...
        try {
            ...
            framework.setAttribute('href', framework.href.replace(reg_domain, 'https://mirror-cdnjs.oss-cn-hangzhou.aliyuncs.com'))
            framework.setAttribute('href', framework.href.replace(reg_path, ''))
        }
    }
})();